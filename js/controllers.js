 ...
 */
phonecatControllers.controller('PhoneListCtrl', ['$scope', 'Phone', 'Allocine',
    function ($scope, Phone, Allocine) {
        ...
        $scope.page = Allocine.getPage('http://www.allocine.fr/recherche/?q=avatar');
